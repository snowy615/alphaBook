...
class TestDisabledProgrammes:
    ...
    def test_only_the_fundamental_side_is_disabled(self):
        assert mb.DISABLED_PROGRAMMES == {mb.M_FUND_BOOTCAMP, mb.M_FUND_ANALYST}
    ...
    def test_fundamental_is_closed(self):
