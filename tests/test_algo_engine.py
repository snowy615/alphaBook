"""Tests for app.algo_engine — the Market Simulation Py contest engine.
...
from app.algo_engine import POSITION_LIMIT, Run
...
class TestLobby:
    ...
    def test_set_code_rejects_a_sandbox_violation(self, run: Run):
        from app.algo_sandbox import SandboxError
