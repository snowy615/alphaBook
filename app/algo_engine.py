"""
Market Simulation Py — the simulation engine.
=============================================

A self-contained algo-trading contest.  Every player submits a Python strategy
(see :mod:`app.algo_sandbox`); the engine calls each one once per tick for ten
...
STARTER_CODE = '''\
# Market Simulation Py — starter strategy
#
